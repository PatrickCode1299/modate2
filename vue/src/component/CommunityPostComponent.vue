...
onMounted(async()=>{
   const response= await axiosClient.post('/fetchAllCommunitiesPost',{email:user_mail}).catch(e=>{
        console.log(e);
    });
