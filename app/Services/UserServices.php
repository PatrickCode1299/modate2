...
// Build the response with only keys
    $response= [
        ...
        'isPaid' => $find_user_matches->isPaid,
        'isPrivate' => $find_user_matches->isPrivate,
        'coverText' => $find_user_matches->coverText,
        'isSound' => $find_user_matches->isSound,
        'coverPhoto' => $find_user_matches->coverPhoto,
        'isColor' => $find_user_matches->isColor,
        'created_at' => $find_user_matches->created_at,
        'updated_at' => $find_user_matches->updated_at,
    ];

// Check if there are matches and return the response
if (!empty($response)) {
